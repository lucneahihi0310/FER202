    ...
    return (
        <Container>
            <Row>
                ...
                <Col xs={9}><h1>Create new Procuct</h1></Col>
            </Row>
            <Row>
                <Col>
                    <Form onSubmit={handleSubmit}>
                        <Row className="mb-3">
                            <Form.Group as={Col}>
                                ...
                                <Form.Control type="text" placeholder="ID" name="id" onChange={e => setId(e.target.value)} />
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col}>
                                ...
                                <Form.Control type="number" min={0} placeholder='Price' name="price" onChange={e => setPrice(parseInt(e.target.value))} />
                                {errors.price && <Form.Text className="text-danger">{errors.price}</Form.Text>}
                            </Form.Group>

                            <Form.Group as={Col}>
                                <Form.Label>Category</Form.Label>
                                <Form.Select defaultValue="Choose..." name="category" onChange={e => setCatId(parseInt(e.target.value))}>
                                    {
                                        categories?.map(c => (
                            ...
                            <Form.Group as={Col}>
                                ...
                                <Form.Control type='number' min={0} placeholder='Quantity' name="quantity" onChange={e => setQuantity(parseInt(e.target.value))} />
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col}>
                                ...
                                <Form.Control type="date" name="createAt" onChange={e => setCreateAt(e.target.value)} />
